...
class DecodeNet(nn.Module):
    def __init__(self, channels):
        ...
        self.conv_channels_down = nn.ConvTranspose2d(channels, 1, 1)
        convList = []
        convList.append(nn.ConvTranspose2d(16, channels, 1))
        convList.append(nn.LeakyReLU())
        for i in range(4):
            convList.append(nn.ConvTranspose2d(channels, channels*4, 1))
            convList.append(nn.LeakyReLU())
