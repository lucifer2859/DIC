...
class EncodeNet(nn.Module):
    def __init__(self):
        ...
        convList = []
        convList.append(baseNet.SampleNet(downSample=True, in_channels=256, out_channels=16, kernel_size=16, stride=16))
...
class DecodeNet(nn.Module):
    def __init__(self):
        ...
        convList = []
        convList.append(baseNet.SampleNet(downSample=False, in_channels=16, out_channels=256, kernel_size=16, stride=16))
